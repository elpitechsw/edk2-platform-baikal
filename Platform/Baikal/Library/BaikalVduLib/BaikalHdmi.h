...
/* Interrupt Registers */
#define BAIKAL_HDMI_IH_I2CM_STAT0         ((UINTN)PcdGet32 (PcdHdmiBase) + 0x0105 * HDMI_REG_WIDTH)
...
#define BAIKAL_HDMI_I2CM_SLAVE            ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E00 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_ADDRESS          ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E01 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_DATAI            ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E03 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_OPERATION        ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E04 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_INT              ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E05 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_CTLINT           ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E06 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_DIV              ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E07 * HDMI_REG_WIDTH)
#define BAIKAL_HDMI_I2CM_SOFTRSTZ         ((UINTN)PcdGet32 (PcdHdmiBase) + 0x7E09 * HDMI_REG_WIDTH)
