...
#define BAIKAL_SMBUS_REGS(bus)  (volatile SMBUS_CONTROLLER_REGS * CONST)((EFI_PHYSICAL_ADDRESS)BAIKAL_SMBUS_BASE + BAIKAL_SMBUS_OFFSET * (bus))
...
{
  volatile SMBUS_CONTROLLER_REGS *CONST  SmbusRegs = BAIKAL_SMBUS_REGS (Bus);
  UINTN  RxedSize = 0;
