...
!if $(BOARD_VER) == 12
  *_*_*_ASLPP_FLAGS = -DELP_$(BOARD_VER) -DELPITECH -DBAIKAL_MBS_2S -D'BAIKAL_BOARD_NAME="$(ELP_BOARD_NAME)"'
!else
...
[PcdsFixedAtBuild.common]
  ...
  gBaikalTokenSpaceGuid.PcdFlashNvStorageDdrCfgBase|0x280000
...
!else
  ...
  gBaikalTokenSpaceGuid.PcdDdrChannelsNumber|6
!endif
!if $(TARGET) == RELEASE
