...
STATIC BAIKAL_ACPI_IORT  Iort = {
  ...
  },
  {
    ...
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE3_P1_SEGMENT, 7, 0),
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE3_P2_SEGMENT, 8, 0),
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE3_P3_SEGMENT, 9, 0),
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE4_P0_SEGMENT, 11, 0),
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE4_P1_SEGMENT, 12, 0),
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE4_P2_SEGMENT, 13, 0),
    BAIKAL_IORT_ROOT_COMPLEX(BAIKAL_ACPI_PCIE4_P3_SEGMENT, 14, 0)
  }
};
#pragma pack()
