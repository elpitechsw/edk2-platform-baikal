...
DefinitionBlock ("Dsdt.aml", "DSDT", 2, "BAIKAL", "BKLEDSDT", 1)
{
  ...
  Scope (\_SB)
  {
    ...
    Name (\_SB.MXC0._DSD, Package ()
    {
      ToUUID ("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
      Package ()
      {
        Package () { "uart-smbus-enabled", One }
      }
    })
  ...
  Scope (\_SB)
  {
    Device (\_SB.I206.PR6F)
    {
      Name (_HID, "PRP0001")
      Name (_UID, PLATFORM_ADDR_OUT_CHIP(0, 0x00CD006F))
      Method (_STA)
      {
        Return (0xF)
      }
      ...
      {
        I2CSerialBusV2 (0x6F, ControllerInitiated, 400000, AddressingMode7Bit, "\\_SB.I206")
      })
      Name (_DSD, Package ()
      {
        ToUUID ("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
