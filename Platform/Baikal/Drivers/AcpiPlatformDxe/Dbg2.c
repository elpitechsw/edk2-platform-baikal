...
#define BAIKAL_DBG2_GAS64(Address)  { EFI_ACPI_6_3_SYSTEM_MEMORY, 64, 0, EFI_ACPI_6_3_QWORD, Address }

#define BAIKAL_DBG2_NUMBER_OF_DEBUG_PORTS                2
#define BAIKAL_DBG2_NUMBER_OF_GENERIC_ADDRESS_REGISTERS  1
#define BAIKAL_DBG2_PORT_SUBTYPE_SERIAL_16550_GAS        0x0012
...
#define BAIKAL_DBG2_PORT(UartBase, UartName)  {                                                    \
  {                                                                                                \
    ...
    /* UINT16  PortSubtype                     */                                                  \
    BAIKAL_DBG2_PORT_SUBTYPE_SERIAL_16550_GAS,                                                     \
    /* UINT8   Reserved[2]                     */                                                  \
