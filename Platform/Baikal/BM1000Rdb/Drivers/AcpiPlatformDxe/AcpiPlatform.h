...
#if defined(BAIKAL_DBM10) || defined(BAIKAL_DBM20) || defined(ELP_1) || defined(ELP_4)
...
#define BAIKAL_ACPI_PCIE0_DBI_BASE  0x02200000
#define BAIKAL_ACPI_PCIE1_DBI_BASE  0x02210000
#define BAIKAL_ACPI_PCIE2_DBI_BASE  0x02220000
#define BAIKAL_ACPI_PCIE_DBI_SIZE   0x1000

#ifdef ELPITECH
#define BAIKAL_ACPI_PCIE0_CFG_BASE  0x40000000 //0x40100000
#define BAIKAL_ACPI_PCIE0_IO_BASE   0x44ff00000
#define BAIKAL_ACPI_PCIE0_MEM_BASE  0x400000000
#define BAIKAL_ACPI_PCIE0_MEM_MIN   0x40000000
#define BAIKAL_ACPI_PCIE0_MEM_SIZE  0x40000000

#define BAIKAL_ACPI_PCIE1_CFG_BASE  0x50000000 //0x50100000
#define BAIKAL_ACPI_PCIE1_IO_BASE   0x50000000
#define BAIKAL_ACPI_PCIE1_MEM_BASE  0x500000000
#define BAIKAL_ACPI_PCIE1_MEM_MIN   0x40000000
#define BAIKAL_ACPI_PCIE1_MEM_SIZE  0x40000000

#define BAIKAL_ACPI_PCIE2_CFG_BASE  0x60000000 //0x60100000
#define BAIKAL_ACPI_PCIE2_IO_BASE   0x60000000
#define BAIKAL_ACPI_PCIE2_MEM_BASE  0x600000000
#define BAIKAL_ACPI_PCIE2_MEM_MIN   0x80000000
#define BAIKAL_ACPI_PCIE2_MEM_SIZE  0x80000000
#else
#define BAIKAL_ACPI_PCIE0_CFG_BASE  0x4000000000
#define BAIKAL_ACPI_PCIE0_IO_BASE   0x4100000000
#define BAIKAL_ACPI_PCIE0_MEM_BASE  0x4200000000
#define BAIKAL_ACPI_PCIE0_MEM_MIN   0x40000000
#define BAIKAL_ACPI_PCIE0_MEM_SIZE  0x40000000

#define BAIKAL_ACPI_PCIE1_CFG_BASE  0x5000000000
#define BAIKAL_ACPI_PCIE1_IO_BASE   0x5100000000
#define BAIKAL_ACPI_PCIE1_MEM_BASE  0x5200000000
#define BAIKAL_ACPI_PCIE1_MEM_MIN   0x40000000
#define BAIKAL_ACPI_PCIE1_MEM_SIZE  0x40000000

#define BAIKAL_ACPI_PCIE2_CFG_BASE  0x6000000000
#define BAIKAL_ACPI_PCIE2_IO_BASE   0x6100000000
#define BAIKAL_ACPI_PCIE2_MEM_BASE  0x6200000000
#define BAIKAL_ACPI_PCIE2_MEM_MIN   0x60000000
#define BAIKAL_ACPI_PCIE2_MEM_SIZE  0x20000000
#endif

#define BAIKAL_ACPI_PCIE_CFG_SIZE   0xff00000
#define BAIKAL_ACPI_PCIE_IO_MIN     0
